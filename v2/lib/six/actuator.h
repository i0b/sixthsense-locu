  ...
  class Actuator {
    ...
    public:
      ...
      typedef struct {
        ...
        Six::actuatorType type;
        Six::executionMode mode;
        bool changed;
        int intensity;
        int parameter;
        int attribute;
      ...
      int addActuator(char* description, Six::actuatorType type, uint8_t numberElements=16,
                      uint8_t baseAddress = 0x40, uint16_t frequency=1000, bool active=true,
                      Six::executionMode mode=Six::executionMode::OFF, bool changed=false,
    ...
    private:
      ...
      _actuatorNode_t* _actuatorList = NULL;
      uint8_t _numberActuators = 0;
